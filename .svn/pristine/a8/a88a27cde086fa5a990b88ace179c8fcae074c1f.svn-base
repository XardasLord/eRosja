...
namespace eRosja
{
    ...
    {
        public static string DB_PATH = Path.Combine(ApplicationData.Current.LocalFolder.Path, "testowa4.db");
        ...
        {            
            ...
            try
            {
                ...
                if (!iso.FileExists(DB_PATH))
                {

                    // *******************************************************************************************************
                    // TUTAJ TWORZY SIĘ BAZA
                    // *******************************************************************************************************

                    // Create a stream for the file in the installation folder.
                    using (Stream input = Application.GetResourceStream(new Uri("testowa4.db", UriKind.Relative)).Stream)
                    {
